...
async function testResumeDetailsFixed() {
  try {
    console.log('🧪 Testing resume details with fixed query...');
    ...
    // Get feedback information (using correct column name)
    ...
    if (feedback.length > 0) {
      console.log('💬 Feedback data:', {
        ...
        has_overall_assessment: !!feedback[0].overall_assessment
      });
    }
